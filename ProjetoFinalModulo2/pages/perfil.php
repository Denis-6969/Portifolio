      ...
      <div class="col-md-8 col-lg-6">
        <div class="card shadow-lg backgroundescuro text-warning">
          <div class="card-body text-center">
            <!-- Foto de Perfil -->
            <img src="../img/imgAluno.png" alt="Foto de Perfil" class="rounded-circle mb-3" width="150" height="150">
            ...
            <!-- Botões -->
            <div class="mt-4">
              <a href="?page=configPerfil" class="btn btn-outline-primary text-warning fw-bold me-2">Editar Perfil</a>
              <?php require_once "../pages/deletarConta.php"?>
              <a href="?page=perguntasUser" class="btn btn-outline-primary text-warning fw-bold">Minhas Perguntas</a>
            </div>
          </div>
        </div>
      </div>
