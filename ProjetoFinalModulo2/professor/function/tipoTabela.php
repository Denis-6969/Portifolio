<?php
 if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_POST['form'] == 'cadPost') {
        ...
        echo '
          <p class="text-center mt-2 bg-primary-subtle text-dark fw-bolder fs-3">STATUS</p>

            <table class="table">
                <thead class="backgroundescuro">
                    <tr>
    ...
    /**CADASTRANDO USUARIO */
        ...
        echo '
          <p class="text-center mt-2 bg-secondary-subtle text-dark fw-bolder fs-3">STATUS</p>
            ...
            <div class="text-center">
                <a href="?page=form_cad_usuarios" class="btn btn-primary text-warning fw-bold">Voltar</a>
            </div>';
    }
}
?>