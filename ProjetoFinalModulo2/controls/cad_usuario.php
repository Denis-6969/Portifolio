            ...
            <div class="row text-warning lead">
                <div class="col-12 col-md-8 col-lg-4 min-vh-100 align-content-center mx-auto">
                    <form action="" method="post" class="p-3 backgroundform rounded-4">
                        ...
                        <p class="display-6 text-center mb-4">Faça o seu Cadastro</p>
                        <div>
                            <input type="hidden" name="form" value="cadUsuario">
                            <label for="email" class="form-label">Nome</label>
                            <input type="text" class="form-control bg-primary-subtle text-primary" name="nome" placeholder="Digite o seu nome de usuário">
                        </div>
                        <div class="mt-2">
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary text-warning form-control mt-3 fw-bold w-100">Cadastrar</button>
                        </div>
                        <div class="mt-4">
